        ...
        <tbody>
            ...
            <?php
                while($filas=mysqli_fetch_array($resultado)){
                    echo "<tr><td>" . $filas["id"] . "    </td><td>" . $filas["nombre"] ."    </td><td>" .  $filas["precio"] . "    </td><td>" . "<a href='EditarBebida.php?id=".$filas["id"]."'>Editar</a> - <a href='EliminarBebida.php?id=".$filas["id"]."'onclick='return confirmar()'>Eliminar</a>" . "    </td><td>" . "</td></tr>";
